...
| `npm run dev:npc` | a generated NPC matches its book statblock exactly, and its gear is a live copy of the pool rather than a second inlined loadout |
