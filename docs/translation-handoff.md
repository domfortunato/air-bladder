...
as of 2026-09-11, measured against the last release (`0.1.20`).

| | |
| --- | --- |
| English interface keys | 1034 |
| translated in `lang/es.json` | 683 (66%) |
| **changed under your translation** | **22** ← Part 1 |
| **content you translated, now unreachable** | **3** ← Part 2 |
| new interface keys, untranslated | 351 ← Part 3 |
...
## Part 1 — interface strings you translated, whose English I have since changed (22)
...
## Part 3 — new interface keys, untranslated (351)
