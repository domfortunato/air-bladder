...
as of 2026-09-13, measured against the last release (`0.1.22`).

| | |
| --- | --- |
| English interface keys | 1061 |
| translated in `lang/es.json` | 694 (65%) |
| **changed under your translation** | **24** ← Part 1 |
| **content you translated, now unreachable** | **3** ← Part 2 |
| new interface keys, untranslated | 367 ← Part 3 |
...
## Part 3 — new interface keys, untranslated (367)
