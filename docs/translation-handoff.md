...
as of 2026-08-09, measured against the last release (`0.1.13`).

| | |
| --- | --- |
| English interface keys | 689 |
| translated in `lang/es.json` | 518 (75%) |
| **changed under your translation** | **14** ← Part 1 |
| **content you translated, now unreachable** | **3** ← Part 2 |
| new interface keys, untranslated | 171 ← Part 3 |
...
## Part 3 — new interface keys, untranslated (171)
...
| `CAIRN.ChangeLog.FeatureAdded` | Feature added: {name} |
| `CAIRN.ChangeLog.FeatureRemoved` | Feature removed: {name} |
...
**The one gap worth knowing about:** the Part 1 baseline was seeded at `0.1.13`, so it
