...
as of 2026-08-10, measured against the last release (`0.1.14`).
...
| new content strings, untranslated | 1956 ← Part 4 |
...
## Part 4 — new content strings, untranslated (1956)
...
**The one gap worth knowing about:** the Part 1 baseline was seeded at `0.1.14`, so it
