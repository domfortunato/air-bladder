...
as of 2026-08-07, measured against the last release (`0.1.11`).
...
| new content strings, untranslated | 1863 ← Part 4 |
...
### Mechanical — nothing for you to do (24)
...
- **24** keyed with HTML entities (`&mdash;`, `&rsquo;`) the browser never asks for — they have never once been displayed.

Fixed our side with `npm run i18n:extract && npm run i18n:import -- --lang es`.
...
## Part 4 — new content strings, untranslated (1863)
