...
as of 2026-09-02, measured against the last release (`0.1.18`).

| | |
| --- | --- |
| English interface keys | 797 |
| translated in `lang/es.json` | 685 (86%) |
| **changed under your translation** | **20** ← Part 1 |
| **content you translated, now unreachable** | **3** ← Part 2 |
| new interface keys, untranslated | 112 ← Part 3 |
...
## Part 1 — interface strings you translated, whose English I have since changed (20)
...
## Part 3 — new interface keys, untranslated (112)
...
| `CAIRN.KWImport.ImportRequested` | Asked the Warden's client to import your character — a cold import can take half a minute. |
