...
| Character and creature galleries | `art/lydia-comer/portraits*`, `tokens*` | 106 | Lydia Comer | CC BY-NC-SA 4.0 | **Stated by the artist** |
...
`lang/en.json` (1,052 interface strings, a count `npm run i18n:check` holds to the file), the Warden guides in `docs/`, both READMEs, and the
listing description.
