...
- 24 GM-visible settings in `module/settings.js` (30 `register` calls; `roles-restamped`,
  ...
  them in its own commit, this one dated 2026-08-11 for `show-grant-tags-print`) —
...
**`docs/release-testing.md` is the full list — 93 probes (`check:probes` states
