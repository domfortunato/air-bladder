 ...
 * the galleries under CC BY-SA 4.0 (2026-09-05 — CC BY for a few hours first,
 * tightened to ShareAlike on her own word the same day; before that, a
 * rewritten direct grant). Neither CC licence bars altering the artwork —
 * BY-SA only requires that adaptations be shared alike.
 *
 ...
 * The logo also stays ALL RIGHTS RESERVED: the CC BY-SA relicence covers the
...
const DEED_URL = "https://creativecommons.org/licenses/by-sa/4.0/";
...
const manifest = {
  _comment: `Generated by tools/import/lydia-comer.mjs. Art: © ${ARTIST}, CC BY-SA 4.0 — see lydia-comer/license.txt (the logo in the parent folder stays all rights reserved).`,
