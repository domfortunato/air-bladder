 ...
 * the galleries — CC BY-NC-SA 4.0 as of 2026-09-07, her third word on it
 * (2026-09-05: CC BY for a few hours, tightened to BY-SA the same day; before
 * that, a rewritten direct grant). No CC licence here bars altering the
 * artwork — ShareAlike requires adaptations carry her licence, NC keeps
 * every use noncommercial.
 *
 ...
 * The logo also stays ALL RIGHTS RESERVED: the CC relicence covers the
...
const DEED_URL = "https://creativecommons.org/licenses/by-nc-sa/4.0/";
...
const manifest = {
  _comment: `Generated by tools/import/lydia-comer.mjs. Art: © ${ARTIST}, CC BY-NC-SA 4.0 — see lydia-comer/license.txt (the logo in the parent folder stays all rights reserved).`,
...
const credits = [
  ...
  `([CC BY-NC-SA 4.0](${DEED_URL})). Source:`,
