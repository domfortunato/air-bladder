...
export const SETTING_KEYS = [
  ...
  "show-features-section", "enable-glog-magic", "use-warden-title",
...
export const registerSettings = () => {
  ...
  game.settings.register(SETTINGS_NS, "enable-glog-magic", {
    name: game.i18n.localize("CAIRN.Settings.EnableGlogMagic.label"),
    hint: game.i18n.localize("CAIRN.Settings.EnableGlogMagic.hint"),
    scope: "world",
    config: true,
    type: Boolean,
    default: false,
