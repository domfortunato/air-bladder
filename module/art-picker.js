 ...
 *   gameicons  2,133 game-icons.net glyphs (CC BY 3.0), browsed CATEGORY FIRST:
 *              35 folder tiles, then that category's thumbnails. The grids are
 *              built on demand — rendering all 35 at once is 2,133 <img> in one
...
export async function pickArt({
  ...
  if (showLydia) {
    ...
    // category-first shape exists to keep 2,133 <img> out of a single dialog.
  ...
  // pane reading "No custom portraits found" with the 2,133-glyph gallery
