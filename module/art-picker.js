 ...
 *   gameicons  2,174 game-icons.net glyphs (CC BY 3.0), browsed CATEGORY FIRST:
 *              36 folder tiles, then that category's thumbnails. The grids are
 *              built on demand — rendering all 36 at once is 2,174 <img> in one
...
export async function pickArt({
  ...
  if (showLydia) {
    ...
    // category-first shape exists to keep 2,174 <img> out of a single dialog.
  ...
  // pane reading "No custom portraits found" with the 2,174-glyph gallery
