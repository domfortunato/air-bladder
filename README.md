...
- **Air Bladder logo — © Lydia Comer, all rights reserved.** The logo and related artwork in `lydia-comer/` are by **Lydia Comer**, licensed to the Air Bladder system for inclusion and unmodified redistribution as part of the system and its forks; all other uses require permission. See `lydia-comer/license.txt`.
