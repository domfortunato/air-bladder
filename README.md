...
- Custom 2e backgrounds — seven ship in the **Backgrounds (Custom)** compendium; [create and lint your own](https://github.com/domfortunato/air-bladder/blob/master/docs/creating-custom-backgrounds.md), [share them across worlds](https://github.com/domfortunato/air-bladder/blob/master/docs/sharing-custom-backgrounds.md), or press **Create Custom Backgrounds and Tables…** once and every shipped background, bond, omen, scar and trait table is yours to edit, or hide any of the shipped ones with an eye toggle
