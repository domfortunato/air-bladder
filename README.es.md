...
- Trasfondos de 2e personalizados — siete se incluyen en el compendio **Backgrounds (Custom)**; [crea y revisa los tuyos](https://github.com/domfortunato/air-bladder/blob/master/docs/creating-custom-backgrounds.md), [compártelos entre mundos](https://github.com/domfortunato/air-bladder/blob/master/docs/sharing-custom-backgrounds.md), o pulsa **Create Custom Backgrounds and Tables…** una vez y todos los trasfondos incluidos, y las tablas de vínculos, presagios, cicatrices y rasgos, pasan a ser tuyos para editarlos, u oculta cualquiera de los incluidos con el icono del ojo
