...
- **Texto del juego — CC BY-SA 4.0.** Las reglas y el texto de Cairn (1.ª y 2.ª edición) son de **Yochai Gal**, con licencia [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/). El contenido de 2e en este sistema hereda esa licencia; las obras derivadas deben compartirse igual y atribuir a Yochai Gal. Eso incluye el texto de las reglas que se distribuye como páginas legibles: el compendio **Cairn 2e Rules** contiene «Overview & Principles» y «Core Rules for Players», transcritos del texto de 2e, y el compendio **Vald** contiene el capítulo de ambientación de la Guía del Guardián del mismo nombre, junto con las 24 fiestas de su calendario, ambos obtenidos del SRD de Cairn. El catálogo de carreras que lee el generador, `module/npc-careers-2e.json`, también es texto del juego.
