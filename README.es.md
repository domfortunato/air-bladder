...
- **Logo y arte de monstruos de Air Bladder — © Lydia Comer, todos los derechos reservados.** Todo el contenido de `lydia-comer/` es de **[Lydia Comer](https://linktr.ee/lydiadidmyink)**, con licencia para el sistema Air Bladder para su inclusión y redistribución sin modificaciones como parte del sistema y sus bifurcaciones (*forks*), y para su uso sin modificaciones en la representación del proyecto; cualquier otro uso requiere permiso. Dos funciones bajo una misma licencia: los archivos del logo, en la raíz de la carpeta, y —en `lydia-comer/portraits/` y `lydia-comer/tokens/`— 17 criaturas dibujadas para este sistema, disponibles en la galería **Lydia Comer** del selector de imágenes en las fichas de PNJ y de monstruo, cada una como un retrato cuadrado emparejado con el token circular recortado a partir de él. **Esta no es una licencia Creative Commons**, a diferencia de todos los demás regímenes de arte aquí: nada puede modificarse ni usarse por separado de Air Bladder. El contenido está listado en `lydia-comer/CREDITS.md`; los términos completos y el historial de la cesión están en `lydia-comer/license.txt`.
