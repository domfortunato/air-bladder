...
- **El Panel del Guardián** ([guía](https://github.com/domfortunato/air-bladder/blob/master/docs/warden-dashboard.md)) — las 41 tablas de tiradas del Guardián, cada una en un botón, en una sola ventana redimensionable y desacoplable: viajes y clima, encuentros por terreno, PNJ, facciones y monstruos. Elige quién ve cada resultado, tira un conjunto entero en una sola tarjeta, y accede a los generadores y al Daño del Guardián desde el mismo sitio
...
La interfaz está traducida al **español** (el 75 % de las cadenas actuales, por [Malecho](https://github.com/fsmalecho)), y el *contenido* del juego —trasfondos, objetos, hechizos, tablas— está traducido únicamente al español.
